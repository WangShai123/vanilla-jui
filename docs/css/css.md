...
vanilla-jui provides a default set of styles with design tokens and component styles.
...
| `--z-badge`     | 2     | Badge       |
| `--z-submenu`   | 5     | Submenu     |
| `--z-drop`      | 9900  | Dropdown    |
| `--z-overlay`   | 9950  | Overlay     |
| `--z-offcanvas` | 9960  | Offcanvas   |
| `--z-popup`     | 9970  | Popup       |
| `--z-toast`     | 9980  | Toast       |
